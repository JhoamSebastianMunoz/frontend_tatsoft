      ...
      <form className="w-full sm:max-w-md mx-auto px-2">
        <div className="relative flex items-center">
          <input
            ...
            className="block w-full py-2 pl-4 pr-10 text-sm text-gray-700 border border-orange-200 rounded-xl  outline-none placeholder:font-semibold placeholder:text-gray-400 sm:py-2 sm:pl-5 sm:pr-12"
