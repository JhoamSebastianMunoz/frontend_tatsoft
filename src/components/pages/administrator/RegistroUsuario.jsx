...
<<<<<<< HEAD:src/pages/administrator/RegistroUsuario.jsx
...
import Boton from "../../../components/atoms/Botones";
>>>>>>> 2b29aaa072bfa5b81ea401657c84a67b85c5fddc:src/components/pages/administrator/RegistroUsuario.jsx
...
<<<<<<< HEAD:src/pages/administrator/RegistroUsuario.jsx
  const validarPaso1 = () => {
    ...
    if (!formData.cedula.trim()) {
      ...
      erroresTemp.cedula = "Ingrese solo números";
      esValido = false;
    } else if (formData.cedula.length < 8 || formData.cedula.length > 10) {
      erroresTemp.cedula = "Debe contener entre 8 y 10 dígitos";
      esValido = false;
    }
  ...
  const validarPaso2 = () => {
    ...
    if (!formData.password) {
      ...
      erroresTemp.password = "Debe incluir al menos una letra mayúscula";
      esValido = false;
    } else if (!/(?=.*[a-z])/.test(formData.password)) {
      erroresTemp.password = "Debe incluir al menos una letra minúscula";
      esValido = false;
    } else if (!/(?=.*\d)/.test(formData.password)) {
      erroresTemp.password = "Debe incluir al menos un número";
      esValido = false;
    } else if (!/(?=.*[!@#$%^&*])/.test(formData.password)) {
      erroresTemp.password = "Debe incluir al menos un carácter especial (!@#$%^&*)";
      esValido = false;
    }

    if (!formData.confirmarPassword) {
      erroresTemp.confirmarPassword = "Confirme su contraseña";
      esValido = false;
