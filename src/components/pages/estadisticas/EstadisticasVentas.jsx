...
const EstadisticasVentas = () => {
  ...
  const formatearSemana = (fechaStr) => {
    ...
    return `${fechaInicio.toLocaleDateString(
      "es-CO",
      options
    )} - ${fechaFin.toLocaleDateString("es-CO", options)}`;
  };
  ...
  useEffect(() => {
    const fetchVentas = async () => {
      try {
        ...
        setAniosDisponibles(
          años.length > 0 ? años : [new Date().getFullYear()]
        );
        ...
        setError(
          "Error al cargar las estadísticas de ventas. Por favor, intente nuevamente."
        );
      } finally {
        setLoading(false);
      }
  ...
  const procesarDatos = (ventasData) => {
    ...
    const total = ventasData.reduce(
      (sum, venta) => sum + venta.total_vendido,
      0
    );
    ...
    const datosColaboradores = Object.values(colaboradores).map(
      (colab, index) => ({
        ...colab,
        porcentaje:
          total > 0 ? ((colab.total / total) * 100).toFixed(1) : "0.0",
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
              ...
              <div className="text-sm text-gray-500 mt-2">
                ...
                {ventasFiltradas.length === 1 ? "venta" : "ventas"} encontradas
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="text-3xl font-bold text-gray-800">
                  {formatearMoneda(
                    Math.max(...ventasFiltradas.map((v) => v.total_vendido), 0)
                  )}
                </div>
                <div className="mt-2 text-sm text-gray-500">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-6">
                {filtroTiempo === "todo"
                  ? "Ventas por Semana"
                  : filtroTiempo === "mes"
                  ? `Ventas de ${nombresMeses[mesSeleccionado]} ${anioSeleccionado}`
                    ...
                    >
                      ...
                      <Tooltip
                        formatter={(value, name) => {
                          if (name === "total")
                            return [formatearMoneda(value), "Total"];
                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: `${colaborador.color}20`,
                            }}
                          >
                            <Icono
                              name="user"
                              size={20}
                              style={{ color: colaborador.color }}
                            />
                          </div>
                        </div>
