  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <div className="fixed top-0 w-full z-10">
        <Encabezado mensaje="Ventas y Devoluciones" />
      </div>
        ...
        <Tipografia>
          <div className="flex flex-col md:flex-row justify-center gap-4 mb-1">
            <div className="bg-white rounded-lg shadow-sm w-full md:max-w-sm mx-auto md:mx-2 m-1">
              <div className="bg-gray-100 py-2 text-center border-b rounded-t-lg">
                <h3 className="text-purple-800 font-medium">Total ventas</h3>
              </div>
              <div className="p-4 text-center">
                ...
                <div className="flex justify-center mb-2">
                  <span className="inline-block px-3 py-0.5 bg-green-100 text-green-600 text-xs font-medium rounded-full">
                    {resumen.ventas.unidades}
                  </span>
                </div>
                <div className="text-xs text-purple-700 font-medium flex justify-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mx-auto px-1 sm:px-2">
            {preventas.map((preventa, index) => (
              ...
              >
                <div className="bg-purple-500 p-2 sm:p-3 text-white flex justify-between items-center">
                ...
                <div className="grid grid-cols-2 gap-0 border-t border-gray-100">
                  <div className="px-3 py-2 sm:px-4 sm:py-3 bg-gray-50 flex flex-col border-r border-gray-100">
                    <span className="text-xs text-purple-900 mb-1">
                      Total ventas
                    </span>
